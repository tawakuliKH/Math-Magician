...
**Math Magicians** is a simple project developed by React.js, Making simple calculations and Read a randome math related quote.
...
Feel free to check the [issues page](https://github.com/tawakuliKH/Math-Magician/issues).
